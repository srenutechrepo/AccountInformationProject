...
public class BalanceDAOImpl_LocalSessionFactoryBean implements BalanceDAO {

	private SessionFactory sessionFactory = null;
	
	public BalanceDAOImpl_LocalSessionFactoryBean() {
	...
	public static void main(String[] args)
		...
		BalanceDAOImpl_LocalSessionFactoryBean impl = new BalanceDAOImpl_LocalSessionFactoryBean();
